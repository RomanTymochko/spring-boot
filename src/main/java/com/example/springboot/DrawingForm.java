...
public class DrawingForm extends JFrame implements Runnable, MouseListener, MouseMotionListener, KeyListener {

    private final int w = 28;
    private final int h = 28;
//    Training images resolution 28*28 px, so we need to scale form for more comfortable drawing
    ...
    public DrawingForm(NeuralNetwork nn) {
        this.nn = nn;
...
//            try { Thread.sleep(17); } catch (InterruptedException e) {}
    ...
    public void paint(Graphics g) {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            else ig.setColor(Color.LIGHT_GRAY);
